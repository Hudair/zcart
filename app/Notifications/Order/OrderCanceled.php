...
class OrderCanceled extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        ->subject( trans('notifications.order_canceled.subject', ['order' => $this->order->order_number]) )
        ->markdown('admin.mail.order.canceled', ['url' => url('/'), 'order' => $this->order]);
    }
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'subject' => trans('notifications.order_canceled.subject', ['order' => $this->order->order_number]),
            'message' => trans('notifications.order_canceled.message', ['order' => $this->order->order_number]),
